...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"4c3c476afe392d845774d8bf2c3fe26c.png\");\n\n//# sourceURL=webpack:///./src/img/explosion.png?");

/***/ }),

/***/ "./src/img/missedshot.png":
/*!********************************!*\
  !*** ./src/img/missedshot.png ***!
  \********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"04fb7b93aed50c696e7cd677707e548a.png\");\n\n//# sourceURL=webpack:///./src/img/missedshot.png?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"d4b8468e8299bfaef4eb26a386f29bbc.jpg\");\n\n//# sourceURL=webpack:///./src/img/ship.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scss/style.scss */ \"./src/scss/style.scss\");\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_style_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _js_Player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/Player */ \"./src/js/Player.js\");\n/* harmony import */ var _js_GameBoard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/GameBoard */ \"./src/js/GameBoard.js\");\n/* harmony import */ var _js_Ship__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/Ship */ \"./src/js/Ship.js\");\n/* harmony import */ var _js_UI__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/UI */ \"./src/js/UI.js\");\n\n\n\n\n\nvar arrayShipsH = [Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(5), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(4), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(3), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(3), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(2)];\nvar arrayShipsPC = [Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(5), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(4), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(3), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(3), Object(_js_Ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(2)];\nvar playerHuman = Object(_js_Player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Player Human', 'H', arrayShipsH);\nvar playerPC = Object(_js_Player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Player Computer', 'C', arrayShipsPC);\nvar gameBoardH = Object(_js_GameBoard__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\nvar gameBoardPC = Object(_js_GameBoard__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\nplayerPC.setTurn(false);\nplayerHuman.setTurn(true);\nplayerHuman.setShips(gameBoardH);\nplayerPC.setShips(gameBoardPC);\n_js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderInitialBoards(playerHuman, gameBoardH);\n_js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderInitialBoards(playerPC, gameBoardPC);\nvar buttons = document.querySelectorAll('.button-position-player2');\nvar event = new Event('build');\nvar sectionPlayer1 = document.getElementById('section-player-1');\n\nvar playHuman = function playHuman(e) {\n  if (!gameBoardPC.IsOver() && !gameBoardH.IsOver() && playerHuman.getTurn()) {\n    var row = parseInt(e.target.dataset.row, 10);\n    var column = parseInt(e.target.dataset.column, 10);\n    console.log('dsfsdfds', row, column);\n    playerHuman.attackRival(gameBoardPC, {\n      row: row,\n      column: column\n    });\n    _js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderAttackBoard(playerPC, gameBoardPC, {\n      row: row,\n      column: column\n    }, e);\n    console.log('PlayHuman', gameBoardPC.getBoard());\n\n    if (gameBoardPC.getIsHit()) {\n      playerPC.setTurn(false);\n      playerHuman.setTurn(true);\n    } else {\n      playerPC.setTurn(true);\n      playerHuman.setTurn(false);\n      _js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].disablePlayer();\n      sectionPlayer1.dispatchEvent(event);\n    }\n  }\n};\n\nvar playComputer = function playComputer() {\n  console.log('dispatch..');\n\n  if (!gameBoardPC.IsOver() && !gameBoardH.IsOver() && playerPC.getTurn()) {\n    playerPC.attackRival(gameBoardH);\n    console.log('PlayPc', gameBoardPC.getBoard());\n    _js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderAttackBoard(playerHuman, gameBoardH);\n\n    if (gameBoardH.getIsHit()) {\n      playerPC.setTurn(true);\n      playerHuman.setTurn(false);\n      setTimeout(function () {\n        sectionPlayer1.dispatchEvent(event);\n      }, 3000);\n    } else {\n      setTimeout(_js_UI__WEBPACK_IMPORTED_MODULE_4__[\"default\"].disablePlayer, 3000);\n      playerPC.setTurn(false);\n      playerHuman.setTurn(true);\n    }\n  }\n};\n\nbuttons.forEach(function (button) {\n  return button.addEventListener('click', playHuman);\n});\nsectionPlayer1.addEventListener('build', playComputer);\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nvar GameBoard = function GameBoard() {\n  var board = _toConsumableArray(Array(10)).map(function () {\n    return Array(10).fill(null);\n  });\n\n  var shipCoordinates = [];\n  var isHit;\n\n  var getBoard = function getBoard() {\n    return board;\n  };\n\n  var renderShipOnBoard = function renderShipOnBoard(ship, position, orientation) {\n    if (orientation === 'V') {\n      for (var i = position.row; i < position.row + ship.length; i += 1) {\n        board[i][position.column] = ship.getType();\n      }\n    } else {\n      for (var _i = position.column; _i < position.column + ship.length; _i += 1) {\n        board[position.row][_i] = ship.getType();\n      }\n    }\n  };\n\n  var IsOver = function IsOver() {\n    return shipCoordinates.length === 0;\n  };\n\n  var validatePosition = function validatePosition(ship, position, orientation) {\n    for (var i = 0; i < shipCoordinates.length; i += 1) {\n      var initialRow = shipCoordinates[i].position.row;\n      var initialCol = shipCoordinates[i].position.column;\n      var finalRow = shipCoordinates[i].position.row + shipCoordinates[i].ship.length - 1;\n      var finalColumn = shipCoordinates[i].position.column + shipCoordinates[i].ship.length - 1;\n\n      if (shipCoordinates[i].orientation === 'V' && orientation === 'V' && (position.row + ship.length - 1 >= initialRow && position.row + ship.length - 1 <= finalRow || position.row >= initialRow && position.row <= finalRow) && initialCol === position.column) {\n        return false;\n      }\n\n      if (shipCoordinates[i].orientation === 'H' && orientation === 'V' && position.row <= initialRow && position.row + ship.length - 1 >= initialRow && initialCol <= position.column && position.column <= finalColumn) {\n        return false;\n      }\n\n      if (shipCoordinates[i].orientation === 'V' && orientation === 'H' && position.column <= initialCol && position.column + ship.length - 1 >= initialCol && initialRow <= position.row && position.row <= finalRow) {\n        return false;\n      }\n\n      if (shipCoordinates[i].orientation === 'H' && orientation === 'H' && (position.column + ship.length - 1 >= initialCol && position.column + ship.length - 1 <= finalColumn || position.column >= initialCol && position.column <= finalColumn) && initialRow === position.row) {\n        return false;\n      }\n    }\n\n    return true;\n  };\n\n  var placeShip = function placeShip(ship, position, orientation) {\n    if (!validatePosition(ship, position, orientation)) return false;\n    shipCoordinates.push({\n      ship: ship,\n      position: position,\n      orientation: orientation\n    });\n    renderShipOnBoard(ship, position, orientation);\n    return true;\n  };\n\n  var isHittingShip = function isHittingShip(position) {\n    for (var i = 0; i < shipCoordinates.length; i += 1) {\n      var initialRow = shipCoordinates[i].position.row;\n      var initialCol = shipCoordinates[i].position.column;\n\n      if (shipCoordinates[i].orientation === 'V' && initialCol === position.column && position.row - initialRow >= 0 && position.row - initialRow <= shipCoordinates[i].ship.length - 1) {\n        shipCoordinates[i].ship.hit(position.row - initialRow);\n        if (shipCoordinates[i].ship.isSunk()) shipCoordinates.splice(i, 1);\n        return true;\n      }\n\n      if (shipCoordinates[i].orientation === 'H' && initialRow === position.row && position.column - initialCol >= 0 && position.column - initialCol <= shipCoordinates[i].ship.length - 1) {\n        shipCoordinates[i].ship.hit(position.column - initialCol);\n        if (shipCoordinates[i].ship.isSunk()) shipCoordinates.splice(i, 1);\n        return true;\n      }\n    }\n\n    return false;\n  };\n\n  var saveAttack = function saveAttack(position) {\n    board[position.row][position.column] = isHit ? 'X' : 'M';\n  };\n\n  var receiveAttack = function receiveAttack(position) {\n    isHit = isHittingShip(position);\n    saveAttack(position);\n  };\n\n  var getIsHit = function getIsHit() {\n    return isHit;\n  };\n\n  return {\n    placeShip: placeShip,\n    receiveAttack: receiveAttack,\n    getIsHit: getIsHit,\n    IsOver: IsOver,\n    getBoard: getBoard\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (GameBoard);\n\n//# sourceURL=webpack:///./src/js/GameBoard.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar Player = function Player(name, type, navalFleet) {\n  var turn;\n\n  var getTurn = function getTurn() {\n    return turn;\n  };\n\n  var setTurn = function setTurn(bool) {\n    turn = bool;\n  };\n\n  var randomPosition = function randomPosition() {\n    var length = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;\n\n    while (true) {\n      var row = Math.round(Math.random() * 9);\n      var column = Math.round(Math.random() * 9);\n\n      if (length !== 0 && row + length < 10 && column + length < 10) {\n        return {\n          row: row,\n          column: column\n        };\n      }\n\n      if (length === 0) {\n        return {\n          row: row,\n          column: column\n        };\n      }\n    }\n  };\n\n  var setShips = function setShips(gameBoard) {\n    for (var index = 0; index < navalFleet.length; index += 1) {\n      var flag = true;\n\n      while (flag) {\n        var orientation = Math.round(Math.random()) === 0 ? 'H' : 'V';\n        var position = randomPosition(navalFleet[index].length);\n        flag = !gameBoard.placeShip(navalFleet[index], position, orientation);\n      }\n    }\n  };\n\n  var attackRival = function attackRival(board) {\n    var position = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n    var positionToAttack = position;\n\n    if (type === 'C') {\n      positionToAttack = randomPosition();\n    }\n\n    board.receiveAttack(positionToAttack);\n    if (!board.getIsHit()) turn = false;\n  };\n\n  return {\n    name: name,\n    type: type,\n    setShips: setShips,\n    getTurn: getTurn,\n    attackRival: attackRival,\n    setTurn: setTurn\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Player);\n\n//# sourceURL=webpack:///./src/js/Player.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar UI = function () {\n  var boardPlayer1 = document.getElementById('board-player-1');\n  var boardPlayer2 = document.getElementById('board-player-2');\n\n  var renderInitialBoards = function renderInitialBoards(player, gameBoard) {\n    var divRender;\n    console.log(player.type);\n\n    if (player.type === 'H') {\n      divRender = boardPlayer1;\n    } else {\n      divRender = boardPlayer2;\n    }\n\n    divRender.innerHTML = '';\n\n    for (var i = 0; i < gameBoard.getBoard().length; i += 1) {\n      var divGroup = document.createElement('div');\n      divGroup.setAttribute('class', 'btn-group size-board');\n\n      for (var j = 0; j < gameBoard.getBoard().length; j += 1) {\n        var button = document.createElement('button');\n        button.setAttribute('class', 'm-1 size-button');\n        button.setAttribute('id', \"btn\".concat(i).concat(j));\n        if (player.type === 'H') button.classList.add(\"color-button-\".concat(gameBoard.getBoard()[i][j]));\n\n        if (player.type === 'C') {\n          button.classList.add('button-position-player2');\n          button.setAttribute('data-row', \"\".concat(i));\n          button.setAttribute('data-column', \"\".concat(j));\n        }\n\n        divGroup.appendChild(button);\n      }\n\n      divRender.appendChild(divGroup);\n    }\n  };\n\n  var renderAttackBoard = function renderAttackBoard(player, gameBoard) {\n    var position = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};\n    var e = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;\n\n    if (player.type === 'H') {\n      renderInitialBoards(player, gameBoard);\n    } else {\n      e.target.classList.add(\"color-button-\".concat(gameBoard.getBoard()[position.row][position.column]));\n    }\n  };\n\n  var disablePlayer = function disablePlayer() {\n    var boardPlayer2 = document.getElementById('board-player-2');\n    boardPlayer2.classList.toggle('disable-player');\n  };\n\n  return {\n    renderInitialBoards: renderInitialBoards,\n    disablePlayer: disablePlayer,\n    renderAttackBoard: renderAttackBoard\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (UI);\n\n//# sourceURL=webpack:///./src/js/UI.js?");
